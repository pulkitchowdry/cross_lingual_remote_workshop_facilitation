...
const en: Dictionary = {
  ...
  captions: {
    ...
    retry: "Retry",
    connectionFailed: "Live captions disconnected. Try again, or use the typed caption box.",
    connectionBlocked: "Live captions couldn't connect. Try again, or use the typed caption box.",
...
const zh: Dictionary = {
  ...
  captions: {
    ...
    retry: "重试",
    connectionFailed: "实时字幕连接已断开。请重试，或使用手动字幕框。",
    connectionBlocked: "实时字幕未能连接。请重试，或使用手动字幕框。",
    sttError: "语音转文字出错。",
...
const es: Dictionary = {
  ...
  captions: {
    ...
    retry: "Reintentar",
    connectionFailed: "Se perdió la conexión de subtítulos en vivo. Vuelve a intentarlo, o usa el cuadro de subtítulos manual.",
    connectionBlocked: "No se pudieron conectar los subtítulos en vivo. Vuelve a intentarlo, o usa el cuadro de subtítulos manual.",
