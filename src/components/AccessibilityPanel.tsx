  ...
  return (
    ...
    <div className="flex items-center gap-[8px]">
      <button
        ...
        className="font-data press-scale flex items-center gap-[6px] whitespace-nowrap rounded-md border border-border-strong px-[10px] py-[4px] text-[11px] font-medium uppercase tracking-wider text-muted-foreground transition-colors hover:border-accent hover:text-foreground"
      >
        Aa
      </button>
      <button
