...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="font-data flex items-center gap-[6px] whitespace-nowrap rounded-md border border-border-strong px-[10px] py-[4px] text-[11px] font-medium uppercase tracking-wider text-muted-foreground press-scale transition-colors duration-150 hover:border-accent hover:text-foreground"
    >
      <span
