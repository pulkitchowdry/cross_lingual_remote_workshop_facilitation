...
export function CopyLinkButton({
  ...
  return (
    <button
      ...
      aria-live="polite"
      className={`font-data w-fit shrink-0 rounded-md border px-4 py-2 text-xs font-medium uppercase tracking-wider press-scale transition-colors duration-150 ${
        status === "copied"
