...
export function ChatSendButton({ label, sendingLabel }: { label: string; sendingLabel: string }) {
  ...
  return (
    <button
      ...
      className="font-data press-scale w-fit whitespace-nowrap rounded-md bg-accent-fill px-4 py-2 text-xs font-medium uppercase tracking-wider text-accent-foreground transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent disabled:cursor-not-allowed disabled:opacity-60"
    >
