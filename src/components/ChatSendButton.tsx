...
export function ChatSendButton({ label, sendingLabel }: { label: string; sendingLabel: string }) {
  ...
  return (
    <button
      ...
      className="font-data w-fit whitespace-nowrap rounded-md bg-accent px-4 py-2 text-xs font-medium uppercase tracking-wider text-accent-foreground disabled:cursor-not-allowed disabled:opacity-60"
    >
