  ...
  return (
    <div className="mx-auto flex max-w-xl animate-fade-in flex-col items-center gap-3 py-16 text-center">
      ...
      <button
        ...
        className="font-data w-fit rounded-md bg-accent-fill px-5 py-2 text-xs font-medium uppercase tracking-wider press-scale transition-colors duration-150 text-accent-foreground"
      >
        {dict.retry}
      </button>
    </div>
